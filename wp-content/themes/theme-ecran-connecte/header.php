            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <?php if(is_user_logged_in()) :
                    ...
                    <ul class="navbar-nav mr-auto">
                        <?php if (in_array('administrator', $user_info->roles) || in_array('adminDept', $user_info->roles) || in_array('communiquant', $user_info->roles) || in_array('secretaire', $user_info->roles)): ?>
                        ...
                        <?php endif;
                        if (in_array('administrator', $user_info->roles) || in_array('adminDept', $user_info->roles)  || in_array('communiquant', $user_info->roles) || in_array('secretaire', $user_info->roles)) : ?>
                            <li class="nav-item dropdown active">
